...
final class Between extends \Zend_Validate_Between {
	 ...
	 * @return self
	 */
	static function i($min, $max = null, $inclusive = true) {/** @noinspection PhpParamsInspection */return
		new self(is_null($min) ? PHP_INT_MIN : $min, is_null($max) ? PHP_INT_MAX : $max, $inclusive)
	;}
}