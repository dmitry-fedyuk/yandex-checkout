 ...
 * @return bool
 */
function df_class_check_abstract($c) {df_param_sne($c, 0); return (new RC($c))->isAbstract();}
 ...
 * @return bool
 */
function df_class_exists($c) {return @class_exists($c);}
 ...
 * @return string
 */
function df_class_file($c) {return df_path_n((new RC(df_cts($c)))->getFileName());}
