...
// 2016-05-19
final class Collection extends \Mage_Directory_Model_Resource_Country_Collection {
	/**
	 * 2016-05-19
	 * Родительский метод зачем-то делает цикл про элементам коллекции.
	 * А мы, по сути, берём реализацию из @see \Varien_Data_Collection::getItemById()
	 * @override
	 * @see \Mage_Directory_Model_Resource_Country_Collection::getItemById()
	...
	function mapFromNameToCode($l = null) {
		...
		if (!isset($this->{__METHOD__}[$l])) {
			$this->{__METHOD__}[$l] = df_ksort_mb(array_flip($this->mapFromCodeToName($l)), $l);
		}
	 ...
	 * 2016-05-19
	 * @override
	 * @see \Mage_Directory_Model_Resource_Country_Collection::_construct()
	 */
